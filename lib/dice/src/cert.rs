...
use crate::{alias_cert_tmpl, id_cert_tmpl, SerialNumber};
...
pub struct DeviceIdCert(#[serde(with = "BigArray")] [u8; id_cert_tmpl::SIZE]);

impl DeviceIdCert {
    #[allow(clippy::new_without_default)]
    pub fn new() -> Self {
        let mut buf = [0u8; id_cert_tmpl::SIZE];
        id_cert_tmpl::fill(&mut buf);

        Self(buf)
    }

    pub fn from(bytes: &[u8; id_cert_tmpl::SIZE]) -> Self {
        Self(*bytes)
    }

    pub fn as_bytes(&self) -> &[u8; id_cert_tmpl::SIZE] {
        &self.0
    }
    ...
    pub fn set_serial_number(mut self, sn: u8) -> Self {
        self.0[id_cert_tmpl::SERIAL_NUMBER_START
            ..id_cert_tmpl::SERIAL_NUMBER_END]
    ...
    pub fn set_issuer_sn(mut self, sn: &SerialNumber) -> Self {
        self.0[id_cert_tmpl::ISSUER_SN_START..id_cert_tmpl::ISSUER_SN_END]
    ...
    pub fn set_notbefore(
        mut self,
        utctime: &[u8; id_cert_tmpl::NOTBEFORE_LENGTH],
    ) -> Self {
        self.0[id_cert_tmpl::NOTBEFORE_START..id_cert_tmpl::NOTBEFORE_END]
    ...
    pub fn set_subject_sn(mut self, sn: &SerialNumber) -> Self {
        self.0[id_cert_tmpl::SUBJECT_SN_START..id_cert_tmpl::SUBJECT_SN_END]
            .copy_from_slice(sn.as_bytes());
    ...
    pub fn set_pub(
        ...
        self.0[id_cert_tmpl::PUB_START..id_cert_tmpl::PUB_END]
    ...
    pub fn set_sig(mut self, sig: &[u8; SIGNATURE_SERIALIZED_LENGTH]) -> Self {
        self.0[id_cert_tmpl::SIG_START..id_cert_tmpl::SIG_END]
            .copy_from_slice(sig);

        self
    }

    fn get_signdata(&self) -> &[u8; id_cert_tmpl::SIGNDATA_LENGTH] {
        self.0[id_cert_tmpl::SIGNDATA_START..id_cert_tmpl::SIGNDATA_END]
            .try_into()
            .unwrap_lite()
    }
...
#[derive(
    Debug, Deserialize, Serialize, SerializedSize,
)]
...
impl AliasCert {
    #[allow(clippy::new_without_default)]
    pub fn new() -> Self {
        let mut buf = [0u8; alias_cert_tmpl::SIZE];
        alias_cert_tmpl::fill(&mut buf);

        Self(buf)
    }

    pub fn as_bytes(&self) -> &[u8; alias_cert_tmpl::SIZE] {
        &self.0
    }
    ...
    pub fn set_serial_number(mut self, sn: u8) -> Self {
        self.0[alias_cert_tmpl::SERIAL_NUMBER_START
            ..alias_cert_tmpl::SERIAL_NUMBER_END]
            .copy_from_slice(&sn.to_be_bytes());
    ...
    pub fn set_issuer_sn(mut self, sn: &SerialNumber) -> Self {
        self.0
            [alias_cert_tmpl::ISSUER_SN_START..alias_cert_tmpl::ISSUER_SN_END]
            .copy_from_slice(sn.as_bytes());
    ...
    pub fn set_subject_sn(mut self, sn: &SerialNumber) -> Self {
        self.0[alias_cert_tmpl::SUBJECT_SN_START
            ..alias_cert_tmpl::SUBJECT_SN_END]
            .copy_from_slice(sn.as_bytes());
    ...
    pub fn set_pub(
        ...
        self.0[alias_cert_tmpl::PUB_START..alias_cert_tmpl::PUB_END]
            .copy_from_slice(pubkey);
    ...
    fn set_sig(mut self, sig: &[u8; SIGNATURE_SERIALIZED_LENGTH]) -> Self {
        self.0[alias_cert_tmpl::SIG_START..alias_cert_tmpl::SIG_END]
            .copy_from_slice(sig);
    ...
    fn get_signdata(&self) -> &[u8; alias_cert_tmpl::SIGNDATA_LENGTH] {
        self.0[alias_cert_tmpl::SIGNDATA_START..alias_cert_tmpl::SIGNDATA_END]
            .try_into()
            .unwrap_lite()
    }
...
mod tests {
    ...
    fn get_issuer_sn(cert: &DeviceIdCert) -> &[u8; 12] {
        cert.0[id_cert_tmpl::ISSUER_SN_START..id_cert_tmpl::ISSUER_SN_END]
            .try_into()
            .unwrap_lite()
    }

    fn get_subject_sn(cert: &DeviceIdCert) -> &[u8; 12] {
        cert.0[id_cert_tmpl::SUBJECT_SN_START..id_cert_tmpl::SUBJECT_SN_END]
            .try_into()
            .unwrap_lite()
    }
    ...
    fn get_serial_number(cert: &DeviceIdCert) -> u8 {
        u8::from_be_bytes(
            cert.0[id_cert_tmpl::SERIAL_NUMBER_START
                ..id_cert_tmpl::SERIAL_NUMBER_END]
                .try_into()
                .unwrap(),
        )
    ...
    fn sign() {
        ...
        for (index, byte) in cert.as_bytes()
            [id_cert_tmpl::SIG_START..id_cert_tmpl::SIG_END]
            .iter()
            .enumerate()
        {
            if index % 12 == 11 {
        ...
        assert_eq!(
            cert.0[id_cert_tmpl::SIG_START..id_cert_tmpl::SIG_END],
            SIG_EXPECTED
        );
    }
}
