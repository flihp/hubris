...
pub const SIZE: usize = 596;
pub const SERIAL_NUMBER_RANGE: Range<usize> = 15..16;
pub const ISSUER_SN_RANGE: Range<usize> = 169..180;
pub const SUBJECT_SN_RANGE: Range<usize> = 367..378;
pub const PUB_RANGE: Range<usize> = 390..422;
pub const SIG_RANGE: Range<usize> = 532..596;
pub const SIGNDATA_RANGE: Range<usize> = 4..522;
pub const FWID_RANGE: Range<usize> = 490..522;
pub const CERT_TMPL: [u8; 596] = [
    0x30, 0x82, 0x02, 0x50, 0x30, 0x82, 0x02, 0x02, 0xa0, 0x03, 0x02, 0x01,
    ...
    0x75, 0x72, 0x69, 0x6e, 0x67, 0x31, 0x19, 0x30, 0x17, 0x06, 0x03, 0x55,
