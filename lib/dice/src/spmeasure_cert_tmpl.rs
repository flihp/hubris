...
pub const SIZE: usize = 583;
pub const SERIAL_NUMBER_RANGE: Range<usize> = 15..16;
pub const ISSUER_SN_RANGE: Range<usize> = 145..156;
pub const SUBJECT_SN_RANGE: Range<usize> = 313..324;
pub const PUB_RANGE: Range<usize> = 336..368;
pub const SIG_RANGE: Range<usize> = 519..583;
pub const SIGNDATA_RANGE: Range<usize> = 4..509;
pub const FWID_RANGE: Range<usize> = 477..509;
pub const CERT_TMPL: [u8; 583] = [
    0x30, 0x82, 0x02, 0x43, 0x30, 0x82, 0x01, 0xf5, 0xa0, 0x03, 0x02, 0x01,
    ...
    0x81, 0x87, 0x30, 0x0f, 0x06, 0x03, 0x55, 0x1d, 0x13, 0x01, 0x01, 0xff,
